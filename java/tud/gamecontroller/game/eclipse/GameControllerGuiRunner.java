...
public class GameControllerGuiRunner extends
		tud.gamecontroller.gui.AbstractGameControllerGuiRunner<Term, Collection<Object>> {

	public GameControllerGuiRunner(ReasonerFactoryInterface<Term, Collection<Object>> reasonerFactory, String[] args) {
