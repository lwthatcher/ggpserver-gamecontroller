...
public class HumanPlayer<TermType extends TermInterface<TermType>, StateType extends StateInterface<TermType, ? extends StateType>>
	...
	@Override
	public MoveInterface<TermType> gamePlay(MoveInterface<TermType> yourMove, Object seesTerms, ConnectionEstablishedNotifier notifier) {
		messageReceiveTime = System.currentTimeMillis();
		return super.gamePlay(yourMove, seesTerms, notifier);
	}
