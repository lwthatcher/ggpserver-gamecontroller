...
public interface Player<TermType extends TermInterface<TermType>, StateType extends StateInterface<TermType, ? extends StateType>> extends NamedObject{
	 ...
	 */
	public MoveInterface<TermType> gamePlay(MoveInterface<TermType> yourMove, Object seesFluents, ConnectionEstablishedNotifier notifier);
	
	public void gameStop(MoveInterface<TermType> yourMove, Object seesTerms, ConnectionEstablishedNotifier notifier);
	/**
	 * 
