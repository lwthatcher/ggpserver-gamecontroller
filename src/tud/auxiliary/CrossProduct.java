...
public class CrossProduct<E> extends AbstractCollection<List<E>> implements
	...
	private final class CrossProductIterator implements
		...
		public CrossProductIterator(List<? extends Iterable<? extends E>> iterables) {
			super();
			tupleSize = iterables.size();
			iterators = new Vector<Iterator<? extends E>>(tupleSize);
		...
		public List<E> next() {
			...
			if(currentTuple!=null) {
				...
				while(i<tupleSize && !iterators.get(i).hasNext()) {
					Iterator<? extends E> iterator = collections.get(i).iterator(); 
	...
	private List<? extends Collection<? extends E>> collections;
	
	public CrossProduct(List<? extends Collection<? extends E>> collections) {
		super();
