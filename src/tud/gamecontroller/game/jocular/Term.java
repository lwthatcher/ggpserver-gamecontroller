...
public class Term extends AbstractTerm<Term, stanfordlogic.prover.Term> {
	...
	public boolean isConstant() {
		return nativeTerm instanceof TermObject;
	}

	public boolean isVariable() {
		return nativeTerm instanceof TermVariable;
	}
	...
	public List<Term> getArgs() {
		if(nativeTerm instanceof TermFunction){
			return new TermList((TermFunction)nativeTerm);
		}else{
			return new TermList(null);
		}
	}
	
	private class TermList extends AbstractList<Term>{
