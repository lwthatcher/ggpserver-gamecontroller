...
public abstract class LocalPlayer<TermType extends TermInterface<TermType>, StateType extends StateInterface<TermType, ? extends StateType>>
	...
	public LocalPlayer(String name, GDLVersion gdlVersion) {
		...
		super(name, GDLVersion.v1); // always treat local players as complete information players to improve performance
	}
	...
	public MoveInterface<TermType> gamePlay(MoveInterface<TermType> lastMove, Object seesTerms, ConnectionEstablishedNotifier notifier) {
		...
		if(seesTerms != null) {
			...
			if (getGdlVersion() == GDLVersion.v1) { // Regular GDL
				...
				statesTracker.statesUpdate(role, lastMove, (Collection<TermType>) seesTerms);
			}
		}
