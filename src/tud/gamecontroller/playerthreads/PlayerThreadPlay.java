...
public class PlayerThreadPlay<
	...
	protected MoveInterface<TermType> lastMove;
	protected MoveInterface<TermType> move;
	protected Object seesTerms;
	
	public PlayerThreadPlay(RoleInterface<TermType> role, Player<TermType, StateType> player, RunnableMatchInterface<TermType, StateType> match, MoveInterface<TermType> lastMove, Object seesTerms, long deadline){
	...
	public void doRun(){
		move = player.gamePlay(lastMove, seesTerms, this);
	}
